...
def rate_table(rates):
    for rate in rates:
            ...
            tandi = 0.046 # assumes 3.6% tax and 1% insurance
...
def rent_eqv(rent):
    ...
    cap_rate = .1033 # all in PITI % at 4% for 30, with 3% in T & I
...
def afford(income, dti):
    ...
    cap_rate = .1033 # all in rate at 4% for 30 with 3.6% fairport taxes and 1% insurance
